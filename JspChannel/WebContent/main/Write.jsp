...
<div class="container">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      action="../member/PostWriteProc?idx=${ idx }" onsubmit="return validateForm(this);">
    ...
    <tr>
        <td>내용</td>
        <td>
            <textarea name="post_contents" style="width:90%;height:100px;"></textarea>
        </td>
    </tr>
    <tr>
        <td>첨부 파일</td>
        <td>
		<input type="file" id="chooseFile" name="post_file"
